...
public class Duke {
    ...
    private static final String COMMAND_BLAH_MESSAGE = TAB + "blah";
    ...
    private static final String COMMAND_INVALID_MESSAGE = "Command is invalid" + LS + "Please try another command";
