# JavaFX Tutorial Part 2 - Creating a GUI for src.main.java.Duke

In this tutorial, we will be creating a GUI for src.main.java.Duke from scratch based on the following mockup.

![Mockup for src.main.java.Duke](assets/DukeMockup.png)
...
![src.main.java.Duke's layout](assets/DukeSceneGraph.png) 
...
![src.main.java.Duke's raw layout](assets/RawLayout.png)
...
```java
    ...
    public void start(Stage stage) {
        ...
        stage.setTitle("src.main.java.Duke");
...
![src.main.java.Duke's Final layout](assets/FinalLayout.png)
