# JavaFX Tutorial Part 2 - Creating a GUI for duke.Duke.duke.Duke

In this tutorial, we will be creating a GUI for duke.Duke.duke.Duke from scratch based on the following mockup.

![Mockup for duke.Duke.duke.Duke](assets/DukeMockup.png)
...
![duke.Duke.duke.Duke's layout](assets/DukeSceneGraph.png) 
...
![duke.Duke.duke.Duke's raw layout](assets/RawLayout.png)
...
```java
    ...
    public void start(Stage stage) {
        ...
        stage.setTitle("duke.Duke.duke.Duke");
...
![duke.Duke.duke.Duke's Final layout](assets/FinalLayout.png)
