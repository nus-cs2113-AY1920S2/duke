# JavaFX Tutorial Part 2 - Creating a GUI for Jan

In this tutorial, we will be creating a GUI for Jan from scratch based on the following mockup.

![Mockup for Jan](assets/DukeMockup.png)
...
![Jan's layout](assets/DukeSceneGraph.png) 
...
![Jan's raw layout](assets/RawLayout.png)
...
![Jan's Final layout](assets/FinalLayout.png)
