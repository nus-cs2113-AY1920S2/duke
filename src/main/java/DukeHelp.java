...
public class DukeHelp {
    ...
    public void printHelp() {
        ...
        System.out.println("   2. deadline: Creates a deadline activity [Syntax: deadline {description} /by {deadline}]");
        ...
        System.out.println("   7. find: find the task list with description matching keywords [Syntax: find {keyword}]");
    }
}