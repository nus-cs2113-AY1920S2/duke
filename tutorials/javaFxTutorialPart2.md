# JavaFX Tutorial Part 2 - Creating a GUI for duke.main.Duke

In this tutorial, we will be creating a GUI for duke.main.Duke from scratch based on the following mockup.

![Mockup for duke.main.Duke](assets/DukeMockup.png)
...
![duke.main.Duke's layout](assets/DukeSceneGraph.png) 
...
![duke.main.Duke's raw layout](assets/RawLayout.png)
...
![duke.main.Duke's Final layout](assets/FinalLayout.png)
