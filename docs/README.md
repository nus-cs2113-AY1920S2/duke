...
### Feature 4 - Listing all the tasks
Shows a list of tasks in the Duke.

Format: `list`

### Feature 5 - Done a task
...
### Feature 7 - Printing tasks for a date
