/**
 * Represents help messages for Duke commands
 */
public class DukeHelp {

    /**
     * Prints all the commands that Duke can understand
     */
    public void printHelp() {
        ...
        System.out.println("   7. find: find the task list with description matching keywords [Syntax: find " +
                "{keyword}]");
    }
}