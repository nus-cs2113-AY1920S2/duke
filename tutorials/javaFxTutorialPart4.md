...
**MainWindow.java**
```java
import duke.main.Duke;import javafx.fxml.FXML;
import javafx.scene.control.Button;
import javafx.scene.control.ScrollPane;
import javafx.scene.control.TextField;
...
Let's create a new `Main` class as the bridge between the existing logic in `duke.main.Duke` and the UI in `MainWindow`.
